...
export train_cmd="queue.pl -q all.q\@compute-0-5 -r y -cwd -V"
export decode_cmd="queue.pl -q all.q\@compute-0-5 -r y -cwd -V"
export mkgraph_cmd="queue.pl -q all.q\@compute-0-5 -r y -cwd -V"
export cuda_cmd=run.pl
