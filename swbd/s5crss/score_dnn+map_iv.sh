...
mkdir -p exp/score.dnn+map; rm -rf exp/score.dnn+map/*
...
run_cds_score(){
    ...
    ivector-compute-dot-products - \
          scp:data/eval2000.dnn+map-iv/ivector.scp \
          scp:data/eval2000.dnn+map-iv/ivector.scp \
          exp/score.dnn+map/cds.output 2> exp/score.dnn+map/cds.log
    ...
    echo "SWBD CDS EER : `compute-eer exp/score.dnn+map/cds.score.key 2> exp/score.dnn+map/cds_EER`"
}
run_cds_score
...
run_lda_plda(){
    ...
    ivector-compute-lda --dim=50 --total-covariance-factor=0.1 \
        'ark:ivector-normalize-length scp:data/train_nodup.dnn+map-iv/ivector.scp ark:- |' \
    ...
    ivector-compute-plda ark:data/train_nodup/spk2utt \
          'ark:ivector-transform exp/score.dnn+map/ivector_plda/lda_transform.mat scp:data/train_nodup.dnn+map-iv/ivector.scp ark:- | ivector-normalize-length ark:-  ark:- |' \
    ...
    ivector-plda-scoring  \
           ...
           "ark:ivector-transform exp/score.dnn+map/ivector_plda/lda_transform.mat scp:data/eval2000.dnn+map-iv/ivector.scp ark:- | ivector-subtract-global-mean ark:- ark:- |" \
           "ark:ivector-transform exp/score.dnn+map/ivector_plda/lda_transform.mat scp:data/eval2000.dnn+map-iv/ivector.scp ark:- | ivector-subtract-global-mean ark:- ark:- |" \
    ...
    echo "SWBD PLDA EER : `compute-eer exp/score.dnn+map/ivector_plda/plda.score.key 2> exp/score.dnn+map/ivector_plda/plda_EER`"
}
#run_lda_plda
...
run_cds_score(){
    ...
    awk '{print $3}' exp/score.dnn+map/cds.output > exp/score.dnn+map/cds.score
    paste exp/score.dnn+map/cds.score $trials_key > exp/score.dnn+map/cds.score.key
    echo "CALLHOME CDS EER : `compute-eer exp/score.dnn+map/cds.score.key 2> exp/score.dnn+map/cds_EER`"
}
#run_cds_score
...
run_lda_plda(){
    ...
    awk '{print $3}' exp/score.dnn+map/ivector_plda/plda.output > exp/score.dnn+map/ivector_plda/plda.score
    paste exp/score.dnn+map/ivector_plda/plda.score $trials_key > exp/score.dnn+map/ivector_plda/plda.score.key
    echo "CALLHOME PLDA EER : `compute-eer exp/score.dnn+map/ivector_plda/plda.score.key 2> exp/score.dnn+map/ivector_plda/plda_EER`"
}
#run_lda_plda
