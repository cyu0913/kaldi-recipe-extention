...
# ./local/noisify.sh data/eval2000/wav.scp /erasable/cxy110530/backup_folder/noises/BABBLE.raw 10 /erasable/cxy110530/backup_folder/eval2000_babble_10dB
...
$add_noise_bin -i $temp_dir/cleanlist -o $temp_dir/nslist -n $noise -f g712 -s $nlevel -r 10 -e $temp_dir/fant.log
