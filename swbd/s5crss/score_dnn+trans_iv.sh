...
run_cds_score(){
    ...
    ivector-compute-dot-products - \
          scp:data/eval2000.dnn+trans-iv/ivector.scp \
          scp:data/eval2000.dnn+trans-iv/ivector.scp \
    ...
    echo "SWBD CDS EER : `compute-eer exp/score.dnn+trans/cds.score.key 2> exp/score.dnn+trans/cds_EER`"
}
run_cds_score
...
run_lda_plda(){
    ...
    ivector-compute-lda --dim=50 --total-covariance-factor=0.1 \
        'ark:ivector-normalize-length scp:data/train_nodup.dnn+trans-iv/ivector.scp ark:- |' \
    ...
    ivector-compute-plda ark:data/train_nodup/spk2utt \
          'ark:ivector-transform exp/score.dnn+trans/ivector_plda/lda_transform.mat scp:data/train_nodup.dnn+trans-iv/ivector.scp ark:- | ivector-normalize-length ark:-  ark:- |' \
    ...
    ivector-plda-scoring  \
           ...
           "ark:ivector-transform exp/score.dnn+trans/ivector_plda/lda_transform.mat scp:data/eval2000.dnn+trans-iv/ivector.scp ark:- | ivector-subtract-global-mean ark:- ark:- |" \
           "ark:ivector-transform exp/score.dnn+trans/ivector_plda/lda_transform.mat scp:data/eval2000.dnn+trans-iv/ivector.scp ark:- | ivector-subtract-global-mean ark:- ark:- |" \
