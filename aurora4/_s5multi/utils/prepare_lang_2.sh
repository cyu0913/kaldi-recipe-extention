...
! utils/validate_dict_dir_2.pl $srcdir && \
...
if ! utils/validate_dict_dir_2.pl $srcdir >&/dev/null; then
  utils/validate_dict_dir_2.pl $srcdir  # show the output.
