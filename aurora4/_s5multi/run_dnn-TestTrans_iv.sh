...
run_dnn_iv_extract(){
   ...
   sid/extract_ivectors_senones.sh --cmd "$train_cmd" --nj 80 \
        exp/extractor_dnn data/test_eval92 exp/tri2b_multi_ali_eval92 data/test_eval92.dnn-TestTrans-iv || exit 1;
