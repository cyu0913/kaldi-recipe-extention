...
run_cds_score(){
    ...
    ivector-compute-dot-products - \
          scp:data/test_eval92.dnn+map-iv/ivector.scp \
          scp:data/test_eval92.dnn+map-iv/ivector.scp \
...
run_lda_plda(){
    ...
    ivector-plda-scoring  \
           ...
           "ark:ivector-transform exp/score.dnn+map/ivector_plda/lda_transform.mat scp:data/test_eval92.dnn+map-iv/ivector.scp ark:- | ivector-subtract-global-mean ark:- ark:- |" \
           "ark:ivector-transform exp/score.dnn+map/ivector_plda/lda_transform.mat scp:data/test_eval92.dnn+map-iv/ivector.scp ark:- | ivector-subtract-global-mean ark:- ark:- |" \
