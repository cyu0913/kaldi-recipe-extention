...
run_lda_plda(){
    ...
    ivector-compute-lda --dim=50 --total-covariance-factor=0.1 \
        'ark:ivector-normalize-length scp:data/test_eval92.dnn+trans-iv/ivector.scp ark:- |' \
    ...
    ivector-compute-plda ark:data/test_eval92/spk2utt \
          'ark:ivector-transform exp/score.dnn+trans/ivector_plda/lda_transform.mat scp:data/test_eval92.dnn+trans-iv/ivector.scp ark:- | ivector-normalize-length ark:-  ark:- |' \
