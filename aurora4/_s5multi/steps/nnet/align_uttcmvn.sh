...
feats="ark,s,cs:copy-feats scp:$sdata/JOB/feats.scp ark:- | apply-cmvn --norm-vars='true' scp:$data/cmvn.scp ark:- ark:- |"
# apply-cmvn (optional),
[ ! -z "$cmvn_opts" -a ! -f $data/cmvn.scp ] && echo "$0: Missing $sdata/1/cmvn.scp" && exit 1
[ ! -z "$cmvn_opts" ] && feats="$feats apply-cmvn $cmvn_opts scp:$data/JOB/cmvn.scp ark:- ark:- |"
# add-deltas (optional),
