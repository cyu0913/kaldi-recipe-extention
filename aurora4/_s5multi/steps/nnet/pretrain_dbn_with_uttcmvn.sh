...
if [ "$copy_feats" == "true" ]; then
  ...
  tmpdir=$(mktemp -d /home/cxy110530/work/kaldi_tmp_trash/$hname/tmp_XXXX); mv $dir/train.scp{,_non_local}
...
if [ ! -z "$cmvn_opts" ]; then
  ...
  feats="$feats apply-cmvn --norm-vars='true' $cmvn_opts $cmvn ark:- ark:- |"
