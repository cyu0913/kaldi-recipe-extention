...
case $feat_type in
  delta) feats="ark,s,cs:apply-cmvn --norm-vars='true' $cmvn_opts scp:$data/cmvn.scp scp:$sdata/JOB/feats.scp ark:- | add-deltas $delta_opts ark:- ark:- |";;
  lda) feats="ark,s,cs:apply-cmvn --norm-vars='true' $cmvn_opts scp:$data/cmvn.scp scp:$sdata/JOB/feats.scp ark:- | splice-feats $splice_opts ark:- ark:- | transform-feats $srcdir/final.mat ark:- ark:- |";;
